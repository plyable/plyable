...
VALUES ('Courage', 'Ability to engage in positive conflict and healthy vulnerability', '', true),
VALUES ('Empathy', 'Patiently meeting the needs of oneself and others', '', true),
VALUES ('Apathy', 'Lack of interest, enthusiasm, or concern', '', false),
VALUES ('Scapegoating', 'Unwarranted blame; misdirection of responsibility', '', false),
VALUES ('Egotism', 'Talking and thinking about oneself excessively because of an undue sense of self-
importance', '', false); 